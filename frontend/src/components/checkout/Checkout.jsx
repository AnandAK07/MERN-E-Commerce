          ...
          <div class="-mx-3 md:flex items-start">
            <div class="px-3 md:w-7/12 lg:pr-10">
              <form class="mb-6 pb-6 text-gray-800" onSubmit={handleSunbmit}>
                <h1 className="m-3 mb-10 font-bold text-2xl">
                  Shipping information
                </h1>
                <div class="mb-3">
                  <div className="flex w-full">
                    <div className="w-full m-2">
                      <label class="text-gray-600 font-semibold text-lg mb-2 ml-1">
                        Full Name
                      </label>
                      <div>
                        <input
                ...
                <div class="mb-3 ">
                  <div className="flex w-full">
                    <div className="w-full m-2">
                      <label class="text-gray-600 font-semibold text-lg mb-2 ml-1">
                        Flat, House No., Building ,Apartment, etc.
                      </label>
                      <div>
                        <input
                          class="w-full px-3 py-2 mb-1 border border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                ...
                <div>
                  <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-2 font-semibold">
                    <i class="mdi mdi-lock-outline mr-1"></i>Submit Address
                  </button>
                </div>
              </form>
            </div>
            ...
            <div class="px-3 mt-24 md:w-5/12 1rem pt-4 pb-4">
              ...
              <div class="mb-6 pb-6 border-b border-gray-200 md:border-none text-gray-800 text-xl">
                <div class="w-full flex items-center">
                  ...
                  <div class="pl-3">
                    <span class="font-semibold text-gray-400 text-sm">IN</span>{" "}
                    <span class="font-semibold">
                      ₹
                      {total
                        ? Math.round(
                            totalPriceOfAllProducts -
                              totalPriceOfAllProducts * 0.1
                          ) + 50
                        : totalPriceOfAllProducts + 50}
                    </span>
                  </div>
                </div>
              </div>
              {Object.keys(details).length ? (
                <div class="w-full mx-auto rounded-lg bg-white border border-gray-200 p-3 text-gray-800 font-light mb-6">
                  ...
                  <div class="w-full flex items-center">
                    ...
                    <div class="flex-grow pl-3">
                      <span>
                        {details.area} {details.flatNo} {details.landmark}{" "}
                        {details.townCity} - {details.pincode} ,{details.state}
                      </span>
                    </div>
                  </div>
                </div>
