...
export const Cart = () => {
    ...
    return (
        <>
        {
                loading?<Loading/>:cart.length==0 ? <div className='flex flex-col justify-center align-center'>
                    <img className='w-full' src='https://fortheloveofgeorge.com.au/wp-content/themes/mrtailor/images/empty_cart_retina.png' alt='Empty cart' />
                    <h1 className='m-auto my-10 text-5xl'>Cart is Empty</h1>
                    <button className='bg-sky-400 m-auto text-white rounded-lg p-3 mb-3' onClick={() => handleNavigate()}>Continue Shoping</button>
                </div>:<>
