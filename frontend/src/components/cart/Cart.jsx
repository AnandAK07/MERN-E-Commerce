    ...
    <>
      {loading ? (
        ...
        <div className="flex flex-col justify-center align-center">
          <img
            className="w-full"
            src="https://fortheloveofgeorge.com.au/wp-content/themes/mrtailor/images/empty_cart_retina.png"
            alt="Empty cart"
          />
          <h1 className="m-auto my-10 text-5xl">Cart is Empty</h1>
          <button
            className="bg-sky-400 m-auto text-white rounded-lg p-3 mb-3"
              ...
              {cart?.map((product) => (
                <div class="justify-between overflow-hidden h-52  mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
                  <img
                    ...
                    alt={product.title}
                    class="object-cover object-center w-full rounded-lg sm:w-40"
                  />
                  <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    ...
                    <div class="mt-4 flex justify-between im sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                      <div class="flex items-center border-gray-100">
                        ...
                        <button
                          className="focus:outline-none"
                          onClick={() => handleUpdate(product.productId, 1)}
                        >
